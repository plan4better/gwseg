...
BASE_DIR="$1"/Paris_Lille3D_50_classes

mkdir -p $BASE_DIR

export url_train="https://cloud.mines-paristech.fr/index.php/s/JhIxgyt0ALgRZ1O/download?path=%2F&files=training_50_classes"
...
mv training_50_classes.zip $BASE_DIR/zip_files
